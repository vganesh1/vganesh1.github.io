/**$*************************************************************
 *file: modifyMethodFrame.java (MUFFIN RELATED)                  *
...
public class modifyMethodFrame extends MuffinFrame implements ActionListener, WindowListener
{
    Prefs prefs;
    modifyMethod parent;
    TextField input = null;
    
    public modifyMethodFrame (Prefs prefs, modifyMethod parent)
    {
	super ("Muffin: modifyMethod");
	...
	panel.add (new Label ("Content types to modifyMethod:", Label.RIGHT));

	input = new TextField (50);
	input.setText (prefs.getString ("modifyMethod.contentTypes"));
